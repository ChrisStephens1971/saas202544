...
**Purpose**: Terraform infrastructure planning

**Jobs**:
- `plan`: Generates Terraform execution plan (currently noop)
...
**Triggers**: Pull requests (when workflow changes), manual dispatch
